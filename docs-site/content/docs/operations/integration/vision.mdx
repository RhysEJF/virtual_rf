---
title: "Integration"
description: "External system connections: Claude CLI, Git, environment management."
---
...
- **Design:** [INTEGRATION.md](/docs/modules/integration/design) - Implementation details, code patterns, and API specs
- **Vision:** [WORKER.md](worker) - How workers spawn Claude processes
