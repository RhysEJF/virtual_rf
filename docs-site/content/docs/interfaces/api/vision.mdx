---
title: "API"
description: "All interfaces are thin clients over a unified conversational API."
---
...
- **Design:** [API.md](/docs/modules/api/design) - Endpoint specifications and implementation
- **Vision:** [DISPATCHER.md](dispatcher) - Request classification (used by converse)
- **Vision:** [DEPLOYMENT.md](deployment) - How API is hosted and accessed
