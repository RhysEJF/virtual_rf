    ...
    return (
      <main className="max-w-6xl mx-auto p-6 pb-20">
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-semibold text-text-primary">Escalation Insights</h1>
      ...
      <div className="mb-6">
        ...
        <div className="flex items-start justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-text-primary">Escalation Insights</h1>
            <p className="text-text-secondary mt-1">
              Analyze patterns in human interventions to reduce worker babysitting
            </p>
          </div>
