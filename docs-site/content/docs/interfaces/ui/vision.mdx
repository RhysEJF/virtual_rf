---
title: "UI Vision"
description: "Frontend components and pages for user interaction."
---
...
- **Design:** [UI.md](/docs/modules/ui/design) - Component inventory, color palette, and implementation patterns
- **Vision:** [DISPATCHER.md](dispatcher) - How command bar routes requests
