---
title: "Cross-Outcome Memory: Vision Document"
description: "Workers learn from ALL outcomes, not just their current one. Memory lives outside Claude.md and is injected per-task at runtime."
---
