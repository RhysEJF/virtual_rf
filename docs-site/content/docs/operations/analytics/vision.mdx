---
title: "Analytics"
description: "Logging, tracking, and self-improvement capabilities."
---
...
- **Design:** [ANALYTICS.md](/docs/modules/analytics/design) - Database schemas, API specs, and algorithm details
- **Vision:** [SUPERVISOR.md](supervisor) - Feeds bottleneck data into analytics
- **Vision:** [SKILLS.md](skills) - Skill gaps trigger skill building
