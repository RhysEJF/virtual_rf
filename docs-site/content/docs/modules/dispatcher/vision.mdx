---
title: "Dispatcher"
description: "The entry point for all user requests. Classifies messy human input and routes to appropriate handlers."
---
...
- **Design:** [DISPATCHER.md](/docs/modules/dispatcher/design) - Implementation details and API specs
