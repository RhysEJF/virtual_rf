---
title: "Refactor for Sharing"
description: "Migration notes from 2026-02-18 — separating app code from user data so Flow can be shared without leaking personal information."
---
