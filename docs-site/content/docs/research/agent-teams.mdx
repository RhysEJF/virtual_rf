---
title: "Agent Teams: Integration Patterns for Ralph Worker Engine"
description: "Research on Claude Code's Agent Teams feature (Feb 2026) and how it could integrate with Flow's Ralph Worker (Wiggum loop) engine."
---
