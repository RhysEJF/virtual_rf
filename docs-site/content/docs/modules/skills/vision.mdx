---
title: "Skills"
description: "Reusable instruction documents that workers load into their context."
---
...
- **Design:** [SKILLS.md](/docs/modules/skills/design) - Implementation details and file structure
- **Vision:** [ORCHESTRATION.md](orchestration) - When skills are built
- **Vision:** [WORKER.md](worker) - How skills are loaded into workers
