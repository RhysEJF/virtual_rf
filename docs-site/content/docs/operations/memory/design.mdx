---
title: "Cross-Outcome Memory - Design"
description: "Implementation details for the Cross-Outcome Memory system."
---
...
*For vision and purpose, see [docs/vision/MEMORY.md](/docs/modules/memory/vision)*
