...
description: "Detailed UI mockups, interaction patterns, and design rationale for the AI workforce management system."
---
...
**Related:** See [VISION.md](vision) for original high-level philosophy.
...
*This document captures the detailed design decisions for Flow. For high-level vision and philosophy, see [VISION.md](vision).*
