---
title: "Supervisor"
description: "Safety and observability layer that monitors workers for stuck states and failures."
---
...
- **Design:** [SUPERVISOR.md](/docs/modules/supervisor/design) - Implementation details, monitoring loop, and configuration
- **Vision:** [WORKER.md](worker) - What the Supervisor monitors
- **Vision:** [ANALYTICS.md](analytics) - How alerts feed into self-improvement
