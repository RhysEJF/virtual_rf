---
title: "Orchestration"
description: "Manages three-phase execution: discover context first, build capabilities second, then execute tasks."
---
...
- **Design:** [ORCHESTRATION.md](/docs/modules/orchestration/design) - Implementation details and API specs
- **Vision:** [WORKER.md](worker) - How workers execute tasks
- **Vision:** [SKILLS.md](skills) - How skills are structured
