...
description: "A personal AI workforce management system that compounds knowledge and capability over time."
---
...
**Related Documents:**
- [DESIGN.md](design) - Original detailed design (historical)
- [CLAUDE.md](claude) - Project coding standards and current progress
...
> **Detailed Mockups:** See [DESIGN.md](design) for comprehensive UI mockups, interaction patterns, and design rationale including the PRD/Design Doc/Tasks separation model.
